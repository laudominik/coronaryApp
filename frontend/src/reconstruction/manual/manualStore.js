...
const ManualPointsStoreContext = createContext(new Store([], "manual_points"))
...
export { XRaysStoreContext, ManualDataStoreContext, ManualErrorStoreContext, ColorsStoreContext, ManualPointsStoreContext }